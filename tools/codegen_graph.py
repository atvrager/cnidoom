...
def emit_graph_h(path: str) -> None:
 ...
 *
 * visual: INT8 [1, 45, 60, 4] NHWC frame stack
 * state:  INT8 [1, 20] quantized game state
 * output: INT8 [1, 6] raw logistic output (before dequant + threshold)
 */
...
def main() -> None:
    ...
    emit_graph_h(os.path.join(args.output_dir, "doom_agent_graph.h"))
